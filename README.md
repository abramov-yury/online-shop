# Сайт объявлений
 ...
 Интерфейс интернет-магазина включает в себя страницу с объявлениями, HTML-форму с фильтрами, модальное окно для вывода подробной информации о товаре. Информация о товарах загружается с сервера. Используются нативные браузерные API.
